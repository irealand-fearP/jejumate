...
`2026-07-13 최우선 인계 — Windows 카카오톡 수집기 재구축`**과
**`2026-07-13 오전 — 대화 내보내기 자동화 완료`**를 먼저 읽을 것.
...
- **[07-13 오전 완료] 카카오톡 내보내기 버튼 자동화**: `kakao_auto_export.ps1`이
  Ctrl+S 기반으로 txt를 자동 생성하고 예약 작업에 연동됨(10분 간격, 포커스 안전장치).
  이제 로그인만 유지되면 전 과정 무인. 자동로그인 활성화 권장.
